...
public class Cliente {
    ...
    private static Object crudVisita(Scanner sc, ArrayList<Visita> visitas) {
		// TODO Auto-generated method stub
		return null;
	}

	private static Object crudDonacion(Scanner sc, ArrayList<Donacion> donaciones) {
		// TODO Auto-generated method stub
		return null;
	}

	private static Object crudExposicion(Scanner sc, ArrayList<Exposicion> exposiciones) {
		// TODO Auto-generated method stub
		return null;
	}

	private static Object crudEvento(Scanner sc, ArrayList<Evento> eventos) {
		// TODO Auto-generated method stub
		return null;
	}

	private static Object crudObra(Scanner sc, ArrayList<Obra> obras) {
		// TODO Auto-generated method stub
		return null;
	}
            ...
            try {
                ...
                switch (op) {
                    case 1 -> {
                        ...
                        System.out.print("Material: ");
                        String material = sc.nextLine();
                        System.out.print("Fecha fabricacion: ");
                        String fecha = sc.nextLine();

                        if (id.isEmpty() || nombre.isEmpty() || material.isEmpty() || fecha.isEmpty()) {
            ...
            try {
                ...
                switch (op) {
                    case 1 -> {
                        ...
                        if (id.isEmpty() || nombre.isEmpty() || nac.isEmpty()) {
                            throw new Exception("Ningun campo puede estar vacio.");
                        }
